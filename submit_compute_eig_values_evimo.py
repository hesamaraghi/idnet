...
if __name__ == "__main__":
    ...
    parser.add_argument("--chunk_size", type=int, required=True, help="Number of samples per job")
    parser.add_argument("--submit_script", type=str, required=True, help="Path to submit_job.sh")
    parser.add_argument(
        "--python_script",
        type=str,
    ...
    parser.add_argument("--submit_once", action="store_true")
